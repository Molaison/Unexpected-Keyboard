...
class DictTrie : AtomDictBase {
 private:
  ...
  // Unexpected Keyboard: the original 600 marks are exhausted by broad
  // prefixes in Rime Ice. Accommodate the 800 matrix DMI nodes and the longer
  // 39-letter composition, keeping mark offsets within their uint16 format.
  static const int kMaxMileStone = 1024;
  static const int kMaxParsingMark = 32768;
