...
// Unexpected Keyboard: accommodate the curated Rime Ice base vocabulary.
const LemmaIdType kSysDictIdEnd = 1000000;

// The first lemma id for the user dictionary.
const LemmaIdType kUserDictIdStart = 1000001;

// The last lemma id (included) for the user dictionary.
const LemmaIdType kUserDictIdEnd = 1100000;
